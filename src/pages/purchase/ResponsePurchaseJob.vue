  ...
  <q-page>
    ...
    <div id="q-app" class="q-pa-md">
      ...
      <div class="q-pa-md">
        <div class="row">
          <div class="col">
            <div class="text-h6"><q-icon name="far fa-user" /> {{responseUser.full_name}}</div>
          </div>
        </div>
        ...
        <q-btn no-caps color='red' class='full-width q-mt-md' type="submit">{{lang.response_the_job}}</q-btn>
...
export default {
  ...
  methods: {
    ...
    commentJob(){
      ...
      //return;
      this.$axios.post('/dev/purchase/commentJob/', qs.stringify(params))
      .then((response) => {
