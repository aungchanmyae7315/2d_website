 ...
 <div id="q-app">
  <q-layout view="lHh Lpr lFf">
    ...
    <q-tabs v-model="selectedTab" align="center">
      <q-route-tab no-caps :to="{ path: '/home'}" exact name="tab-1" icon="img:statics/icons_header/dimond_icon.png" label="Home">
      ...
      <q-route-tab no-caps :to="{ path: '/service/service',query: {type: 'service'}}" exact name="tab-3" icon="img:statics/icons_service/service_t_icon.png" label="Service">
